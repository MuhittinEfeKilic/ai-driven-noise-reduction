...
CROP_SIZE = 128
WORKER_BASE_SEED = 42
BEST_CHECKPOINT_NAME = "periodic_unet_l1_best.pt"
LAST_CHECKPOINT_NAME = "periodic_unet_l1_last.pt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the Periodic U-Net denoiser with L1 loss.")
