...
from train_noise_map_residual_cnn import SmallResidualCNN  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SAR residual-CNN noise-map inference.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/sar/noise_map_residual_cnn_inference"))
...
def load_model(model_path: Path, use_incidence_scalar: bool, device: torch.device) -> SmallResidualCNN:
