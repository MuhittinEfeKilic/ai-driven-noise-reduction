...
BATCH_SIZE = 16
NUM_WORKERS = 2
CHECKPOINT_PATH = Path("models/denoisers/speckle/speckle_unet_residual_hybrid_best.pt")
CLEAN_DIR = Path("data/clean/bsd500")
NOISY_DIR = Path("data/synthetic/speckle")
OUTPUT_DIR = Path("outputs/speckle_residual_hybrid_test")
...
def main() -> None:
    ...
    for noisy_batch, clean_batch, names in tqdm(loader, desc="Testing Speckle Residual Hybrid", unit="batch"):
