...
BATCH_SIZE = 16
NUM_WORKERS = 2
CHECKPOINT_PATH = Path("archive_models/denoisers/periodic/archive/periodic_unet_l1_best.pt")
CLEAN_DIR = Path("data/clean/bsd500")
NOISY_DIR = Path("data/synthetic/periodic")
OUTPUT_DIR = Path("outputs/periodic_l1_test")
...
def main() -> None:
    ...
    for noisy_batch, clean_batch, names in tqdm(loader, desc="Testing Periodic L1", unit="batch"):
