...
OUTPUT_DIR = Path("outputs/periodic_residual_hybrid_test")
...
def main() -> None:
    ...
    for noisy_batch, clean_batch, names in tqdm(loader, desc="Testing Periodic Residual Hybrid", unit="batch"):
